...
#include "higgsanalysis/Objects/interface/RecoElectron.h" // RecoElectron
#include "higgsanalysis/Objects/interface/RecoMuon.h" // RecoMuon
...
#include "higgsanalysis/CommonTools/interface/LocalFileInPath.h" // LocalFileInPath
#include "higgsanalysis/CommonTools/interface/sysUncertOptions.h" // kHadTauPt_*
