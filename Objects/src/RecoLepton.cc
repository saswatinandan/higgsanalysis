...
#include "higgsanalysis/Objects/interface/RecoLepton.h" // RecoLepton, ChargedParticle
#include "higgsanalysis/Objects/interface/GenHadTau.h" // GenHadTau
#include "higgsanalysis/Objects/interface/GenJet.h" // GenJet
#include "higgsanalysis/Objects/interface/analysisAuxFunctions.h" // cmsException(), as_integer() 
...
void
RecoLepton::setjetBtagCSV(double btagscore)// = Btag::kDeepJet)
{
  assocJetBtagCSVs_ = btagscore;
  //  std::cout << "********assocJetBtagCSVs_ " << assocJetBtagCSVs_ << std::endl;
}
