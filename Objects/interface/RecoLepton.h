#ifndef RecoLepton_h
#define RecoLepton_h
#include "higgsanalysis/Objects/interface/ChargedParticle.h" // ChargedParticle
...
//--- common observables for electrons and muons
  ...
  float assocJetBtagCSVs_; ///< CSV b-tagging discriminator values of nearby jet found via jetIdx branch
