#include "higgsanalysis/Reader/interface/L1PreFiringWeightReader.h" // L1PreFiringWeightReader

#include "higgsanalysis/CommonTools/interface/BranchAddressInitializer.h" // BranchAddressInitializer, TTree, Form()
#include "higgsanalysis/CommonTools/interface/Era.h" // Era::k2018
#include "higgsanalysis/CommonTools/interface/sysUncertOptions.h" // L1PreFiringWeightSys
