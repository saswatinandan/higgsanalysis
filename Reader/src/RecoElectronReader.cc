#include "higgsanalysis/Reader/interface/RecoElectronReader.h"
#include "higgsanalysis/Reader/interface/RecoLeptonReader.h"         // RecoLeptonReader 
#include "higgsanalysis/Objects/interface/analysisAuxFunctions.h"     // setValue_float()   
...
#include "higgsanalysis/CommonTools/interface/Era.h"     // Era::k*        
...
RecoElectronReader::RecoElectronReader(Era era,
                                       bool isMC)
  : RecoElectronReader(era, "Electron", isMC)
{}
...
RecoElectronReader::RecoElectronReader(Era era,
  ...
  , leptonReader_(new RecoLeptonReader(branchName_obj_, era, isMC))
  , eCorr_(nullptr)
