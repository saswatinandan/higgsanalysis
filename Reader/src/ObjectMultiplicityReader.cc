#include "higgsanalysis/Reader/interface/ObjectMultiplicityReader.h"

#include "higgsanalysis/Objects/interface/ObjectMultiplicity.h"
#include "higgsanalysis/Objects/interface/analysisAuxFunctions.h" // kLoose, kFakeable, kTight, TauID::
