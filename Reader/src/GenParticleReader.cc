...
#include "higgsanalysis/CommonTools/interface/BranchAddressInitializer.h" // BranchAddressInitializer
...
GenParticleReader::GenParticleReader(const std::string & branchName_obj)
  : max_nParticles_(512)
