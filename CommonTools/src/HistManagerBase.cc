...
#include "higgsanalysis/CommonTools/interface/HistManagerBase.h"

#include "higgsanalysis/CommonTools/interface/cmsException.h" // cmsException()
#include "higgsanalysis/CommonTools/interface/histogramAuxFunctions.h" // createSubdirectory_recursively()
