#ifndef JetHistManagerAK8_h
#define JetHistManagerAK8_h
...
#include "higgsanalysis/HistManager/interface/HistManagerBase.h" // HistManagerBase
...
private:
  ...
  TH1 * histogram_deepTagMD_bbvsLight_;
  TH1 * histogram_particleNetMD_Xbb_;
