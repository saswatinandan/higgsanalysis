#include "higgsanalysis/HistManager/interface/JetHistManagerAK8.h"

#include "higgsanalysis/CommonTools/interface/cmsException.h" // cmsException()
#include "higgsanalysis/CommonTools/interface/histogramAuxFunctions.h" // fillWithOverFlow()
#include "higgsanalysis/Objects/interface/RecoSubjetAK8.h"
...
JetHistManagerAK8::bookHistograms(TFileDirectory & dir)
{
  ...
  histogram_deepTagMD_bbvsLight_ = book1D(dir, "deepTagMD_bbvsLight",  "deepTagMD_bbvsLight", 50, 0, 1.);
  histogram_particleNetMD_Xbb_ = book1D(dir, "particleNetMD_Xbb", "particleNetMD_Xbb", 50, 0., 1.);
                                    ...
                                    double evtWeight)
{
  ...
  fillWithOverFlow(histogram_deepTagMD_bbvsLight_, jet.deepTagMD_bbvsLight(), evtWeight, evtWeightErr);
  fillWithOverFlow(histogram_particleNetMD_Xbb_, jet.particleNetMD_Xbb(), evtWeight, evtWeightErr);
