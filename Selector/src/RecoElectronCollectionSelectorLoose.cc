#include "higgsanalysis/Selector/interface/RecoElectronCollectionSelectorLoose.h" // RecoElectronSelectorLoose

#include "higgsanalysis/CommonTools/interface/Era.h" // Era::k*
#include "higgsanalysis/CommonTools/interface/cmsException.h"         // cmsException(), assert()
